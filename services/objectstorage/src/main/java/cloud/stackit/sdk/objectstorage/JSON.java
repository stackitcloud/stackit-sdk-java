...
public class JSON {
	...
	static {
		...
		gsonBuilder.registerTypeAdapterFactory(
				new cloud.stackit.sdk.objectstorage.model.CreateAccessKeyResponse
						.CustomTypeAdapterFactory());
		gsonBuilder.registerTypeAdapterFactory(
				new cloud.stackit.sdk.objectstorage.model.CreateBucketResponse
						.CustomTypeAdapterFactory());
		gsonBuilder.registerTypeAdapterFactory(
				new cloud.stackit.sdk.objectstorage.model.CreateCredentialsGroupPayload
						.CustomTypeAdapterFactory());
		gsonBuilder.registerTypeAdapterFactory(
				new cloud.stackit.sdk.objectstorage.model.CreateCredentialsGroupResponse
						.CustomTypeAdapterFactory());
		gsonBuilder.registerTypeAdapterFactory(
		...
		gsonBuilder.registerTypeAdapterFactory(
				new cloud.stackit.sdk.objectstorage.model.DeleteAccessKeyResponse
						.CustomTypeAdapterFactory());
		gsonBuilder.registerTypeAdapterFactory(
				new cloud.stackit.sdk.objectstorage.model.DeleteBucketResponse
						.CustomTypeAdapterFactory());
		gsonBuilder.registerTypeAdapterFactory(
		...
		gsonBuilder.registerTypeAdapterFactory(
				new cloud.stackit.sdk.objectstorage.model.HTTPValidationError
						.CustomTypeAdapterFactory());
		gsonBuilder.registerTypeAdapterFactory(
				new cloud.stackit.sdk.objectstorage.model.ListAccessKeysResponse
						.CustomTypeAdapterFactory());
		gsonBuilder.registerTypeAdapterFactory(
				new cloud.stackit.sdk.objectstorage.model.ListBucketsResponse
						.CustomTypeAdapterFactory());
		gsonBuilder.registerTypeAdapterFactory(
				new cloud.stackit.sdk.objectstorage.model.ListCredentialsGroupsResponse
						.CustomTypeAdapterFactory());
		gsonBuilder.registerTypeAdapterFactory(
