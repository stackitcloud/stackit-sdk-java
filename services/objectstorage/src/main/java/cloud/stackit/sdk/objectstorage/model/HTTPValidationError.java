...
public class HTTPValidationError {
	...
	@javax.annotation.Nullable private List<ValidationError> detail = new ArrayList<>();
	 ...
	 * @return detail
	 */
	@javax.annotation.Nullable public List<ValidationError> getDetail() {
		return detail;
	}
	...
	public static void validateJsonElement(JsonElement jsonElement) throws IOException {
		if (jsonElement == null) {
			if (!HTTPValidationError.openapiRequiredFields
		...
		for (Map.Entry<String, JsonElement> entry : entries) {
			if (!HTTPValidationError.openapiFields.contains(entry.getKey())) {
				throw new IllegalArgumentException(
						String.format(
								java.util.Locale.ROOT,
								"The field `%s` in the JSON string is not defined in the `HTTPValidationError` properties. JSON: %s",
								entry.getKey(),
	...
	public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
		...
		public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
			...
			return (TypeAdapter<T>)
					new TypeAdapter<HTTPValidationError>() {
						@Override
						public void write(JsonWriter out, HTTPValidationError value)
								throws IOException {
