...
public class ErrorMessage {
	...
	private List<DetailedError> detail = new ArrayList<>();

	public ErrorMessage() {}

	public ErrorMessage detail(@javax.annotation.Nonnull List<DetailedError> detail) {
		this.detail = detail;
		return this;
	}

	public ErrorMessage addDetailItem(DetailedError detailItem) {
		if (this.detail == null) {
	 ...
	 */
	@javax.annotation.Nonnull
	public List<DetailedError> getDetail() {
		return detail;
	}

	public void setDetail(@javax.annotation.Nonnull List<DetailedError> detail) {
		this.detail = detail;
	}
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(this.detail, errorMessage.detail)
	...
	public static void validateJsonElement(JsonElement jsonElement) throws IOException {
		if (jsonElement == null) {
			if (!ErrorMessage.openapiRequiredFields
		...
		for (int i = 0; i < jsonArraydetail.size(); i++) {
			DetailedError.validateJsonElement(jsonArraydetail.get(i));
		}
		;
	}
