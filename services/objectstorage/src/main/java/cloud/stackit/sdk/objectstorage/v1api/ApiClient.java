...
public class ApiClient {
	...
	protected String basePath = "https://object-storage.api.eu01.stackit.cloud";
	protected List<ServerConfiguration> servers =
			new ArrayList<ServerConfiguration>(
					Arrays.asList(
							new ServerConfiguration(
									"https://object-storage.api.{region}stackit.cloud",
	 ...
	 * Set base path
	 *
	 * @param basePath Base path of the URL (e.g https://object-storage.api.eu01.stackit.cloud)
	 ...
	 * @return a {@link cloud.stackit.sdk.objectstorage.v1api.ApiClient} object
	 */
