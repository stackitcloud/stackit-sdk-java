...
public class DetailedError {
	...
	public DetailedError key(@javax.annotation.Nonnull String key) {
		this.key = key;
		return this;
	}
	...
	public DetailedError msg(@javax.annotation.Nonnull String msg) {
		this.msg = msg;
		return this;
	}
	 ...
	 * @return the DetailedError instance itself
	 */
	public DetailedError putAdditionalProperty(String key, Object value) {
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(this.key, detailedError.key)
				&& Objects.equals(this.msg, detailedError.msg)
				&& Objects.equals(this.additionalProperties, detailedError.additionalProperties);
	}

	@Override
	public int hashCode() {
		return Objects.hash(key, msg, additionalProperties);
	}
	...
	static {
		...
		openapiFields = new HashSet<String>(Arrays.asList("key", "msg"));

		// a set of required properties/fields (JSON key names)
		openapiRequiredFields = new HashSet<String>(Arrays.asList("key", "msg"));
	}
	...
	public static void validateJsonElement(JsonElement jsonElement) throws IOException {
		if (jsonElement == null) {
			if (!DetailedError.openapiRequiredFields
			...
			return (TypeAdapter<T>)
					new TypeAdapter<DetailedError>() {
						...
						public DetailedError read(JsonReader in) throws IOException {
							...
							DetailedError instance = thisAdapter.fromJsonTree(jsonObj);
