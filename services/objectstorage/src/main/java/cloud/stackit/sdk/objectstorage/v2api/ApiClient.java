...
public class ApiClient {
	...
	protected String basePath = "https://object-storage.api.stackit.cloud";
	protected List<ServerConfiguration> servers =
			new ArrayList<ServerConfiguration>(
					Arrays.asList(
							new ServerConfiguration(
									"https://object-storage.api.stackit.cloud",
	...
	protected void init() {
		...
		setUserAgent("stackit-sdk-java/objectstorage");
	}
	 ...
	 * Set base path
	 *
	 * @param basePath Base path of the URL (e.g https://object-storage.api.stackit.cloud)
	 ...
	 * @return a {@link cloud.stackit.sdk.objectstorage.v2api.ApiClient} object
	 */
