...
public class BackupProperties {
	 ...
	 * @return the BackupProperties instance itself
	 */
	public BackupProperties putAdditionalProperty(String key, Object value) {
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(this.name, backupProperties.name)
				...
				&& Objects.equals(this.additionalProperties, backupProperties.additionalProperties);
	}
			...
			return (TypeAdapter<T>)
					new TypeAdapter<BackupProperties>() {
						...
						public BackupProperties read(JsonReader in) throws IOException {
							...
							BackupProperties instance = thisAdapter.fromJsonTree(jsonObj);
