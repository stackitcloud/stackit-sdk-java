...
public class ApiClient {
	...
	protected String basePath = "https://server-backup.api.stackit.cloud";
	protected List<ServerConfiguration> servers =
			new ArrayList<ServerConfiguration>(
					Arrays.asList(
							new ServerConfiguration(
									"https://server-backup.api.stackit.cloud",
	 ...
	 * @return a {@link cloud.stackit.sdk.serverbackup.v2api.ApiClient} object
	 */
