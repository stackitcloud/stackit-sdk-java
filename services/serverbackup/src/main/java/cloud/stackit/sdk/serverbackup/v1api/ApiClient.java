...
public class ApiClient {
	...
	protected String basePath = "https://server-backup.api.eu01.stackit.cloud";
	protected List<ServerConfiguration> servers =
			new ArrayList<ServerConfiguration>(
					Arrays.asList(
							new ServerConfiguration(
									"https://server-backup.api.{region}stackit.cloud",
	...
	protected void init() {
		...
		setUserAgent("stackit-sdk-java/serverbackup");
	}
	 ...
	 * Set base path
	 *
	 * @param basePath Base path of the URL (e.g https://server-backup.api.eu01.stackit.cloud)
	 ...
	 * @return a {@link cloud.stackit.sdk.serverbackup.v1api.ApiClient} object
	 */
