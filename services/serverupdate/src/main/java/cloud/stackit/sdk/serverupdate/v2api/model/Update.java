...
public class Update {
	 ...
	 * @return the Update instance itself
	 */
	public Update putAdditionalProperty(String key, Object value) {
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(this.endDate, update.endDate)
				...
				&& Objects.equals(this.additionalProperties, update.additionalProperties);
	}
			...
			return (TypeAdapter<T>)
					new TypeAdapter<Update>() {
						...
						public Update read(JsonReader in) throws IOException {
							...
							Update instance = thisAdapter.fromJsonTree(jsonObj);
