...
public class ApiClient {
	...
	protected String basePath = "https://server-update.api.stackit.cloud";
	protected List<ServerConfiguration> servers =
			new ArrayList<ServerConfiguration>(
					Arrays.asList(
							new ServerConfiguration(
									"https://server-update.api.stackit.cloud",
	 ...
	 * @return a {@link cloud.stackit.sdk.serverupdate.v2api.ApiClient} object
	 */
