...
public class ApiClient {
	...
	protected String basePath = "https://server-update.api.eu01.stackit.cloud";
	protected List<ServerConfiguration> servers =
			new ArrayList<ServerConfiguration>(
					Arrays.asList(
							new ServerConfiguration(
									"https://server-update.api.{region}stackit.cloud",
	...
	protected void init() {
		...
		setUserAgent("stackit-sdk-java/serverupdate");
	}
	 ...
	 * Set base path
	 *
	 * @param basePath Base path of the URL (e.g https://server-update.api.eu01.stackit.cloud)
	 ...
	 * @return a {@link cloud.stackit.sdk.serverupdate.v1api.ApiClient} object
	 */
