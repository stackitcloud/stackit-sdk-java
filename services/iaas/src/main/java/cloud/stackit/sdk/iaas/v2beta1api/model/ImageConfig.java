...
public class ImageConfig {
	 ...
	 * @return the ImageConfig instance itself
	 */
	public ImageConfig putAdditionalProperty(String key, Object value) {
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(this.architecture, imageConfig.architecture)
				...
				&& Objects.equals(this.additionalProperties, imageConfig.additionalProperties);
	}
			...
			return (TypeAdapter<T>)
					new TypeAdapter<ImageConfig>() {
						...
						public ImageConfig read(JsonReader in) throws IOException {
							...
							ImageConfig instance = thisAdapter.fromJsonTree(jsonObj);
