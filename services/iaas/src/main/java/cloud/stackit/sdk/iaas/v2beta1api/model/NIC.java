...
public class NIC {
	...
	public NIC description(@javax.annotation.Nullable String description) {
	 ...
	 * @return the NIC instance itself
	 */
	public NIC putAdditionalProperty(String key, Object value) {
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(this.allowedAddresses, NIC.allowedAddresses)
				...
				&& Objects.equals(this.additionalProperties, NIC.additionalProperties);
	}
			...
			return (TypeAdapter<T>)
					new TypeAdapter<NIC>() {
						...
						public NIC read(JsonReader in) throws IOException {
							...
							NIC instance = thisAdapter.fromJsonTree(jsonObj);
