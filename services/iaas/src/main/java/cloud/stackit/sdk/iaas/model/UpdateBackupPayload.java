...
public class UpdateBackupPayload {
	...
	public UpdateBackupPayload description(@javax.annotation.Nullable String description) {
	...
	public UpdateBackupPayload labels(@javax.annotation.Nullable Object labels) {
		this.labels = labels;
		return this;
	}
	...
	public UpdateBackupPayload name(@javax.annotation.Nullable String name) {
		this.name = name;
		return this;
	}
	 ...
	 * @return the UpdateBackupPayload instance itself
	 */
	public UpdateBackupPayload putAdditionalProperty(String key, Object value) {
	...
	public boolean equals(Object o) {
		...
		UpdateBackupPayload updateBackupPayload = (UpdateBackupPayload) o;
		return Objects.equals(this.availabilityZone, updateBackupPayload.availabilityZone)
				&& Objects.equals(this.createdAt, updateBackupPayload.createdAt)
				&& Objects.equals(this.description, updateBackupPayload.description)
				&& Objects.equals(this.encrypted, updateBackupPayload.encrypted)
				&& Objects.equals(this.id, updateBackupPayload.id)
				&& Objects.equals(this.labels, updateBackupPayload.labels)
				&& Objects.equals(this.name, updateBackupPayload.name)
				&& Objects.equals(this.size, updateBackupPayload.size)
				&& Objects.equals(this.snapshotId, updateBackupPayload.snapshotId)
				&& Objects.equals(this.status, updateBackupPayload.status)
				&& Objects.equals(this.updatedAt, updateBackupPayload.updatedAt)
				&& Objects.equals(this.volumeId, updateBackupPayload.volumeId)
				&& Objects.equals(
						this.additionalProperties, updateBackupPayload.additionalProperties);
	}
	...
	public String toString() {
		...
		sb.append("class UpdateBackupPayload {\n");
	 ...
	 * @throws IOException if the JSON Element is invalid with respect to UpdateBackupPayload
	 */
	public static void validateJsonElement(JsonElement jsonElement) throws IOException {
		if (jsonElement == null) {
			if (!UpdateBackupPayload.openapiRequiredFields
					.isEmpty()) { // has required fields but JSON element is null
				throw new IllegalArgumentException(
						String.format(
								java.util.Locale.ROOT,
								"The required field(s) %s in UpdateBackupPayload is not found in the empty JSON string",
								UpdateBackupPayload.openapiRequiredFields.toString()));
			}
		}
	...
	public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
		...
		public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
			if (!UpdateBackupPayload.class.isAssignableFrom(type.getRawType())) {
				return null; // this class only serializes 'UpdateBackupPayload' and its subtypes
			}
			final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
			final TypeAdapter<UpdateBackupPayload> thisAdapter =
					gson.getDelegateAdapter(this, TypeToken.get(UpdateBackupPayload.class));

			return (TypeAdapter<T>)
					new TypeAdapter<UpdateBackupPayload>() {
						@Override
						public void write(JsonWriter out, UpdateBackupPayload value)
								throws IOException {
						...
						@Override
						public UpdateBackupPayload read(JsonReader in) throws IOException {
							JsonElement jsonElement = elementAdapter.read(in);
							validateJsonElement(jsonElement);
							JsonObject jsonObj = jsonElement.getAsJsonObject();
							// store additional fields in the deserialized instance
							UpdateBackupPayload instance = thisAdapter.fromJsonTree(jsonObj);
	...
	/**
	 * Create an instance of UpdateBackupPayload given an JSON string
	 *
	 * @param jsonString JSON string
	 * @return An instance of UpdateBackupPayload
	 * @throws IOException if the JSON string is invalid with respect to UpdateBackupPayload
	 */
	public static UpdateBackupPayload fromJson(String jsonString) throws IOException {
		return JSON.getGson().fromJson(jsonString, UpdateBackupPayload.class);
	}

	/**
	 * Convert an instance of UpdateBackupPayload to an JSON string
	 *
	 * @return JSON string
	 */
