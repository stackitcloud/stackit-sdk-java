...
public class SecurityGroupRule {
	...
	public SecurityGroupRule direction(@javax.annotation.Nonnull String direction) {
	...
	public SecurityGroupRule ethertype(@javax.annotation.Nullable String ethertype) {
	...
	public SecurityGroupRule icmpParameters(
	...
	public SecurityGroupRule ipRange(@javax.annotation.Nullable String ipRange) {
	...
	public SecurityGroupRule portRange(@javax.annotation.Nullable PortRange portRange) {
	...
	public SecurityGroupRule remoteSecurityGroupId(
	 ...
	 * @return the SecurityGroupRule instance itself
	 */
	public SecurityGroupRule putAdditionalProperty(String key, Object value) {
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(this.createdAt, securityGroupRule.createdAt)
				...
				&& Objects.equals(this.ipRange, securityGroupRule.ipRange)
				...
				&& Objects.equals(
						this.additionalProperties, securityGroupRule.additionalProperties);
	}
			...
			if (!SecurityGroupRule.openapiRequiredFields
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"The required field(s) %s in SecurityGroupRule is not found in the empty JSON string",
								SecurityGroupRule.openapiRequiredFields.toString()));
			}
		}

		// check to make sure all required properties/fields are present in the JSON string
		for (String requiredField : SecurityGroupRule.openapiRequiredFields) {
			...
			return (TypeAdapter<T>)
					new TypeAdapter<SecurityGroupRule>() {
						...
						public SecurityGroupRule read(JsonReader in) throws IOException {
							...
							SecurityGroupRule instance = thisAdapter.fromJsonTree(jsonObj);
