...
public class CreateAffinityGroupPayload {
	 ...
	 * @return the CreateAffinityGroupPayload instance itself
	 */
	public CreateAffinityGroupPayload putAdditionalProperty(String key, Object value) {
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(this.id, createAffinityGroupPayload.id)
				...
				&& Objects.equals(
						this.additionalProperties, createAffinityGroupPayload.additionalProperties);
	}
			...
			return (TypeAdapter<T>)
					new TypeAdapter<CreateAffinityGroupPayload>() {
						...
						public CreateAffinityGroupPayload read(JsonReader in) throws IOException {
							...
							CreateAffinityGroupPayload instance = thisAdapter.fromJsonTree(jsonObj);
