...
public class NetworkIPv4 {
	 ...
	 * @return the NetworkIPv4 instance itself
	 */
	public NetworkIPv4 putAdditionalProperty(String key, Object value) {
			...
			return (TypeAdapter<T>)
					new TypeAdapter<NetworkIPv4>() {
						...
						public NetworkIPv4 read(JsonReader in) throws IOException {
							...
							NetworkIPv4 instance = thisAdapter.fromJsonTree(jsonObj);
