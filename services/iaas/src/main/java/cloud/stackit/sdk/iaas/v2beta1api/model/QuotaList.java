...
public class QuotaList {
	 ...
	 * @return the QuotaList instance itself
	 */
	public QuotaList putAdditionalProperty(String key, Object value) {
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(this.backupGigabytes, quotaList.backupGigabytes)
				...
				&& Objects.equals(this.additionalProperties, quotaList.additionalProperties);
	}
			...
			return (TypeAdapter<T>)
					new TypeAdapter<QuotaList>() {
						...
						public QuotaList read(JsonReader in) throws IOException {
							...
							QuotaList instance = thisAdapter.fromJsonTree(jsonObj);
