...
public class ServerAgent {
	 ...
	 * @return the ServerAgent instance itself
	 */
	public ServerAgent putAdditionalProperty(String key, Object value) {
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(this.provisioned, serverAgent.provisioned)
				&& Objects.equals(this.additionalProperties, serverAgent.additionalProperties);
	}

	@Override
	public int hashCode() {
		return Objects.hash(provisioned, additionalProperties);
	}
			...
			return (TypeAdapter<T>)
					new TypeAdapter<ServerAgent>() {
						...
						public ServerAgent read(JsonReader in) throws IOException {
							...
							ServerAgent instance = thisAdapter.fromJsonTree(jsonObj);
