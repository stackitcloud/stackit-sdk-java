...
public class NetworkIPv6 {
	 ...
	 * @return the NetworkIPv6 instance itself
	 */
	public NetworkIPv6 putAdditionalProperty(String key, Object value) {
			...
			return (TypeAdapter<T>)
					new TypeAdapter<NetworkIPv6>() {
						...
						public NetworkIPv6 read(JsonReader in) throws IOException {
							...
							NetworkIPv6 instance = thisAdapter.fromJsonTree(jsonObj);
