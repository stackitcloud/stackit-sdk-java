...
public class UpdateNetworkAddressFamily {
	 ...
	 * @return the UpdateNetworkAddressFamily instance itself
	 */
	public UpdateNetworkAddressFamily putAdditionalProperty(String key, Object value) {
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(this.ipv4, updateNetworkAddressFamily.ipv4)
				...
				&& Objects.equals(
						this.additionalProperties, updateNetworkAddressFamily.additionalProperties);
	}
			...
			return (TypeAdapter<T>)
					new TypeAdapter<UpdateNetworkAddressFamily>() {
						...
						public UpdateNetworkAddressFamily read(JsonReader in) throws IOException {
							...
							UpdateNetworkAddressFamily instance = thisAdapter.fromJsonTree(jsonObj);
