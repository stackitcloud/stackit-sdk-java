...
public class Server {
	...
	@javax.annotation.Nullable private ServerNetworking networking;
	...
	public Server agent(@javax.annotation.Nullable ServerAgent agent) {
		this.agent = agent;
		return this;
	}
	...
	public Server networking(@javax.annotation.Nullable ServerNetworking networking) {
	 ...
	 * @return networking
	 */
	@javax.annotation.Nullable public ServerNetworking getNetworking() {
		return networking;
	}

	public void setNetworking(@javax.annotation.Nullable ServerNetworking networking) {
		this.networking = networking;
	}
	 ...
	 * @return the Server instance itself
	 */
	public Server putAdditionalProperty(String key, Object value) {
	...
	public static void validateJsonElement(JsonElement jsonElement) throws IOException {
		...
		if (jsonObj.get("networking") != null && !jsonObj.get("networking").isJsonNull()) {
			ServerNetworking.validateJsonElement(jsonObj.get("networking"));
		}
			...
			return (TypeAdapter<T>)
					new TypeAdapter<Server>() {
						...
						public Server read(JsonReader in) throws IOException {
							...
							Server instance = thisAdapter.fromJsonTree(jsonObj);
