...
public class CreateKeyPairPayload {
	 ...
	 * @return the CreateKeyPairPayload instance itself
	 */
	public CreateKeyPairPayload putAdditionalProperty(String key, Object value) {
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(this.createdAt, createKeyPairPayload.createdAt)
				...
				&& Objects.equals(
						this.additionalProperties, createKeyPairPayload.additionalProperties);
	}
			...
			return (TypeAdapter<T>)
					new TypeAdapter<CreateKeyPairPayload>() {
						...
						public CreateKeyPairPayload read(JsonReader in) throws IOException {
							...
							CreateKeyPairPayload instance = thisAdapter.fromJsonTree(jsonObj);
