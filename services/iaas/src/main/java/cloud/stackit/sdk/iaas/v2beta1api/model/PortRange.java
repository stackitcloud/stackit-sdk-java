...
public class PortRange {
	 ...
	 * @return the PortRange instance itself
	 */
	public PortRange putAdditionalProperty(String key, Object value) {
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(this.max, portRange.max)
				&& Objects.equals(this.min, portRange.min)
				&& Objects.equals(this.additionalProperties, portRange.additionalProperties);
	}
			...
			return (TypeAdapter<T>)
					new TypeAdapter<PortRange>() {
						...
						public PortRange read(JsonReader in) throws IOException {
							...
							PortRange instance = thisAdapter.fromJsonTree(jsonObj);
