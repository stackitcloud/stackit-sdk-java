...
public class VPCNetworkRangeIPv6 {
	...
	public VPCNetworkRangeIPv6(OffsetDateTime createdAt, UUID id, OffsetDateTime updatedAt) {
		this();
	...
	/**
	 * The ipv6 prefix lengths for subnets or network ranges in the VPC. minimum: 0 maximum: 128
	 *
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(this.createdAt, vpCNetworkRangeIPv6.createdAt)
				...
				&& Objects.equals(
						this.additionalProperties, vpCNetworkRangeIPv6.additionalProperties);
	}
	...
	public static void validateJsonElement(JsonElement jsonElement) throws IOException {
		if (jsonElement == null) {
			if (!VPCNetworkRangeIPv6.openapiRequiredFields
					.isEmpty()) { // has required fields but JSON element is null
				throw new IllegalArgumentException(
						String.format(
								java.util.Locale.ROOT,
								"The required field(s) %s in VPCNetworkRangeIPv6 is not found in the empty JSON string",
								VPCNetworkRangeIPv6.openapiRequiredFields.toString()));
			}
		}
	...
	public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
		...
		public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
			...
			return (TypeAdapter<T>)
					new TypeAdapter<VPCNetworkRangeIPv6>() {
						@Override
						public void write(JsonWriter out, VPCNetworkRangeIPv6 value)
								throws IOException {
