...
public class MachineType {
	 ...
	 * @return the MachineType instance itself
	 */
	public MachineType putAdditionalProperty(String key, Object value) {
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(this.description, machineType.description)
				...
				&& Objects.equals(this.additionalProperties, machineType.additionalProperties);
	}

	@Override
	public int hashCode() {
		return Objects.hash(description, disk, extraSpecs, name, ram, vcpus, additionalProperties);
	}
			...
			return (TypeAdapter<T>)
					new TypeAdapter<MachineType>() {
						...
						public MachineType read(JsonReader in) throws IOException {
							...
							MachineType instance = thisAdapter.fromJsonTree(jsonObj);
