...
public class Snapshot {
	...
	public Snapshot description(@javax.annotation.Nullable String description) {
	 ...
	 * @return the Snapshot instance itself
	 */
	public Snapshot putAdditionalProperty(String key, Object value) {
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(this.createdAt, snapshot.createdAt)
				...
				&& Objects.equals(this.additionalProperties, snapshot.additionalProperties);
	}
			...
			return (TypeAdapter<T>)
					new TypeAdapter<Snapshot>() {
						...
						public Snapshot read(JsonReader in) throws IOException {
							...
							Snapshot instance = thisAdapter.fromJsonTree(jsonObj);
