...
public class JSON {
		...
		GsonFireBuilder fireBuilder =
				new GsonFireBuilder()
						.registerTypeSelector(
								cloud.stackit.sdk.iaas.model.ManagementRouteDestination.class,
								new TypeSelector<
										cloud.stackit.sdk.iaas.model.ManagementRouteDestination>() {
									@Override
									public Class<
													? extends
										...
										classByDiscriminatorValue.put(
												"ManagementRoute_destination",
												cloud.stackit.sdk.iaas.model
														.ManagementRouteDestination.class);
						...
						.registerTypeSelector(
								cloud.stackit.sdk.iaas.model.ManagementRouteNexthop.class,
								new TypeSelector<
										cloud.stackit.sdk.iaas.model.ManagementRouteNexthop>() {
									@Override
									public Class<
													? extends
															cloud.stackit.sdk.iaas.model
	...
	static {
		...
		gsonBuilder.registerTypeAdapterFactory(
				new cloud.stackit.sdk.iaas.model.CreateManagementNetworkPayload
						.CustomTypeAdapterFactory());
		gsonBuilder.registerTypeAdapterFactory(
				new cloud.stackit.sdk.iaas.model.CreateManagementNetworkRoutePayload
						.CustomTypeAdapterFactory());
		gsonBuilder.registerTypeAdapterFactory(
		...
		gsonBuilder.registerTypeAdapterFactory(
				new cloud.stackit.sdk.iaas.model.MachineTypeListResponse
						.CustomTypeAdapterFactory());
		gsonBuilder.registerTypeAdapterFactory(
				new cloud.stackit.sdk.iaas.model.ManagementRoute.CustomTypeAdapterFactory());
		gsonBuilder.registerTypeAdapterFactory(
				new cloud.stackit.sdk.iaas.model.ManagementRouteDestination
						.CustomTypeAdapterFactory());
		gsonBuilder.registerTypeAdapterFactory(
				new cloud.stackit.sdk.iaas.model.ManagementRouteListResponse
						.CustomTypeAdapterFactory());
		gsonBuilder.registerTypeAdapterFactory(
				new cloud.stackit.sdk.iaas.model.ManagementRouteNexthop.CustomTypeAdapterFactory());
		gsonBuilder.registerTypeAdapterFactory(
		...
		gsonBuilder.registerTypeAdapterFactory(
				new cloud.stackit.sdk.iaas.model.UpdateManagementNetworkRoutePayload
						.CustomTypeAdapterFactory());
		gsonBuilder.registerTypeAdapterFactory(
		...
		gsonBuilder.registerTypeAdapterFactory(
				new cloud.stackit.sdk.iaas.model.V2beta1ConfigureNetworkAreaRegionPayload
						.CustomTypeAdapterFactory());
		gsonBuilder.registerTypeAdapterFactory(
				new cloud.stackit.sdk.iaas.model.V2beta1CreateSnapshotPayload
						.CustomTypeAdapterFactory());
		gsonBuilder.registerTypeAdapterFactory(
				new cloud.stackit.sdk.iaas.model.V2beta1UpdateBackupPayload
						.CustomTypeAdapterFactory());
		gsonBuilder.registerTypeAdapterFactory(
				new cloud.stackit.sdk.iaas.model.V2beta1UpdateNetworkAreaRegionPayload
						.CustomTypeAdapterFactory());
		gsonBuilder.registerTypeAdapterFactory(
				new cloud.stackit.sdk.iaas.model.V2beta1UpdateRouteOfAreaPayload
						.CustomTypeAdapterFactory());
		gsonBuilder.registerTypeAdapterFactory(
				new cloud.stackit.sdk.iaas.model.V2beta1UpdateSecurityGroupPayload
						.CustomTypeAdapterFactory());
		gsonBuilder.registerTypeAdapterFactory(
				new cloud.stackit.sdk.iaas.model.V2beta1UpdateSnapshotPayload
						.CustomTypeAdapterFactory());
		gsonBuilder.registerTypeAdapterFactory(
