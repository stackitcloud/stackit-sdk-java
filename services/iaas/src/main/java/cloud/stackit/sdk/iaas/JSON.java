...
public class JSON {
	...
	static {
		...
		gsonBuilder.registerTypeAdapterFactory(
				new cloud.stackit.sdk.iaas.model.V2ConfigureNetworkAreaRegionPayload
						.CustomTypeAdapterFactory());
		gsonBuilder.registerTypeAdapterFactory(
				new cloud.stackit.sdk.iaas.model.V2CreateSnapshotPayload
						.CustomTypeAdapterFactory());
		gsonBuilder.registerTypeAdapterFactory(
				new cloud.stackit.sdk.iaas.model.V2UpdateBackupPayload.CustomTypeAdapterFactory());
		gsonBuilder.registerTypeAdapterFactory(
				new cloud.stackit.sdk.iaas.model.V2UpdateNetworkAreaRegionPayload
						.CustomTypeAdapterFactory());
		gsonBuilder.registerTypeAdapterFactory(
				new cloud.stackit.sdk.iaas.model.V2UpdateRouteOfAreaPayload
						.CustomTypeAdapterFactory());
		gsonBuilder.registerTypeAdapterFactory(
				new cloud.stackit.sdk.iaas.model.V2UpdateSecurityGroupPayload
						.CustomTypeAdapterFactory());
		gsonBuilder.registerTypeAdapterFactory(
				new cloud.stackit.sdk.iaas.model.V2UpdateSnapshotPayload
						.CustomTypeAdapterFactory());
		gsonBuilder.registerTypeAdapterFactory(
