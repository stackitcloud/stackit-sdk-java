...
public class NetworkArea {
	 ...
	 * @return the NetworkArea instance itself
	 */
	public NetworkArea putAdditionalProperty(String key, Object value) {
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(this.createdAt, networkArea.createdAt)
				...
				&& Objects.equals(this.additionalProperties, networkArea.additionalProperties);
	}

	@Override
	public int hashCode() {
		return Objects.hash(
				createdAt, id, labels, name, projectCount, updatedAt, additionalProperties);
	}
			...
			return (TypeAdapter<T>)
					new TypeAdapter<NetworkArea>() {
						...
						public NetworkArea read(JsonReader in) throws IOException {
							...
							NetworkArea instance = thisAdapter.fromJsonTree(jsonObj);
