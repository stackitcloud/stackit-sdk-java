...
public class CreatePublicIPPayload {
	 ...
	 * @return the CreatePublicIPPayload instance itself
	 */
	public CreatePublicIPPayload putAdditionalProperty(String key, Object value) {
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(this.id, createPublicIPPayload.id)
				...
				&& Objects.equals(
						this.additionalProperties, createPublicIPPayload.additionalProperties);
	}
			...
			return (TypeAdapter<T>)
					new TypeAdapter<CreatePublicIPPayload>() {
						...
						public CreatePublicIPPayload read(JsonReader in) throws IOException {
							...
							CreatePublicIPPayload instance = thisAdapter.fromJsonTree(jsonObj);
