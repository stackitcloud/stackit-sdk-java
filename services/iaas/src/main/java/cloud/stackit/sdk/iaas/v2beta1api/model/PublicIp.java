...
public class PublicIp {
	...
	public PublicIp(UUID id, String ip) {
		this();
		this.id = id;
		this.ip = ip;
	}
	...
	public PublicIp labels(@javax.annotation.Nullable Object labels) {
		this.labels = labels;
		return this;
	}
	...
	public PublicIp networkInterface(@javax.annotation.Nullable UUID networkInterface) {
	 ...
	 * @return the PublicIp instance itself
	 */
	public PublicIp putAdditionalProperty(String key, Object value) {
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(this.id, publicIp.id)
				&& Objects.equals(this.ip, publicIp.ip)
				&& Objects.equals(this.labels, publicIp.labels)
				&& Objects.equals(this.networkInterface, publicIp.networkInterface)
				&& Objects.equals(this.additionalProperties, publicIp.additionalProperties);
	}
	 ...
	 * @throws IOException if the JSON Element is invalid with respect to PublicIp
	 */
			...
			if (!PublicIp.openapiRequiredFields
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"The required field(s) %s in PublicIp is not found in the empty JSON string",
			...
			return (TypeAdapter<T>)
					new TypeAdapter<PublicIp>() {
						...
						public PublicIp read(JsonReader in) throws IOException {
							...
							PublicIp instance = thisAdapter.fromJsonTree(jsonObj);
