...
public class BaseSecurityGroupRule {
	 ...
	 * @return the BaseSecurityGroupRule instance itself
	 */
	public BaseSecurityGroupRule putAdditionalProperty(String key, Object value) {
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(this.createdAt, baseSecurityGroupRule.createdAt)
				...
				&& Objects.equals(
						this.additionalProperties, baseSecurityGroupRule.additionalProperties);
	}
			...
			return (TypeAdapter<T>)
					new TypeAdapter<BaseSecurityGroupRule>() {
						...
						public BaseSecurityGroupRule read(JsonReader in) throws IOException {
							...
							BaseSecurityGroupRule instance = thisAdapter.fromJsonTree(jsonObj);
