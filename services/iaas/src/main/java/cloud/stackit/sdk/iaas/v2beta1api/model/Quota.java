...
public class Quota {
	 ...
	 * @return the Quota instance itself
	 */
	public Quota putAdditionalProperty(String key, Object value) {
	...
	public boolean equals(Object o) {
		...
		Quota quota = (Quota) o;
		return Objects.equals(this.limit, quota.limit)
				&& Objects.equals(this.usage, quota.usage)
				&& Objects.equals(this.additionalProperties, quota.additionalProperties);
	}

	@Override
	public int hashCode() {
		return Objects.hash(limit, usage, additionalProperties);
	}
			...
			return (TypeAdapter<T>)
					new TypeAdapter<Quota>() {
						...
						public Quota read(JsonReader in) throws IOException {
							...
							Quota instance = thisAdapter.fromJsonTree(jsonObj);
