...
public class ServerNetwork {
	 ...
	 * @return the ServerNetwork instance itself
	 */
	public ServerNetwork putAdditionalProperty(String key, Object value) {
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(this.allowedAddresses, serverNetwork.allowedAddresses)
				...
				&& Objects.equals(this.additionalProperties, serverNetwork.additionalProperties);
	}
			...
			return (TypeAdapter<T>)
					new TypeAdapter<ServerNetwork>() {
						...
						public ServerNetwork read(JsonReader in) throws IOException {
							...
							ServerNetwork instance = thisAdapter.fromJsonTree(jsonObj);
