...
public class Backup {
	...
	public Backup description(@javax.annotation.Nullable String description) {
	...
	public Backup labels(@javax.annotation.Nullable Object labels) {
		this.labels = labels;
		return this;
	}
	...
	public Backup name(@javax.annotation.Nullable String name) {
		this.name = name;
		return this;
	}
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(this.availabilityZone, backup.availabilityZone)
				...
				&& Objects.equals(this.snapshotId, backup.snapshotId)
				&& Objects.equals(this.status, backup.status)
				&& Objects.equals(this.updatedAt, backup.updatedAt)
				&& Objects.equals(this.volumeId, backup.volumeId)
