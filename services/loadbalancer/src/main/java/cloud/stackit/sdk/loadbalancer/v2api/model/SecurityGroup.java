...
public class SecurityGroup {
	 ...
	 * @return the SecurityGroup instance itself
	 */
	public SecurityGroup putAdditionalProperty(String key, Object value) {
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(this.id, securityGroup.id)
				...
				&& Objects.equals(this.additionalProperties, securityGroup.additionalProperties);
	}
			...
			return (TypeAdapter<T>)
					new TypeAdapter<SecurityGroup>() {
						...
						public SecurityGroup read(JsonReader in) throws IOException {
							...
							SecurityGroup instance = thisAdapter.fromJsonTree(jsonObj);
