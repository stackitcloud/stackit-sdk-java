...
public class ApiClient {
	...
	protected String basePath = "https://load-balancer.api.eu01.stackit.cloud";
	protected List<ServerConfiguration> servers =
			new ArrayList<ServerConfiguration>(
					Arrays.asList(
							new ServerConfiguration(
									"https://load-balancer.api.{region}stackit.cloud",
	 ...
	 * Set base path
	 *
	 * @param basePath Base path of the URL (e.g https://load-balancer.api.eu01.stackit.cloud)
	 ...
	 * @return a {@link cloud.stackit.sdk.loadbalancer.v1api.ApiClient} object
	 */
