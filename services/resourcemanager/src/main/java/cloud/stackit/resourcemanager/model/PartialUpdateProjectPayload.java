...
public class PartialUpdateProjectPayload {
  ...
  public PartialUpdateProjectPayload containerParentId(@javax.annotation.Nullable String containerParentId) {
  ...
  public PartialUpdateProjectPayload labels(@javax.annotation.Nullable Map<String, String> labels) {
    this.labels = labels;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PartialUpdateProjectPayload
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PartialUpdateProjectPayload.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PartialUpdateProjectPayload is not found in the empty JSON string", PartialUpdateProjectPayload.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PartialUpdateProjectPayload.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PartialUpdateProjectPayload` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PartialUpdateProjectPayload.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PartialUpdateProjectPayload' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<PartialUpdateProjectPayload>() {
           @Override
           public void write(JsonWriter out, PartialUpdateProjectPayload value) throws IOException {
