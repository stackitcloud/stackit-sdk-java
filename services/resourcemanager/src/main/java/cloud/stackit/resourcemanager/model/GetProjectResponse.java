...
public class GetProjectResponse {
  ...
  public GetProjectResponse lifecycleState(@javax.annotation.Nonnull LifecycleState lifecycleState) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(containerId, creationTime, labels, lifecycleState, name, parent, parents, projectId, updateTime);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("containerId", "creationTime", "labels", "lifecycleState", "name", "parent", "parents", "projectId", "updateTime"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("containerId", "creationTime", "lifecycleState", "name", "parent", "projectId", "updateTime"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetProjectResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetProjectResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
