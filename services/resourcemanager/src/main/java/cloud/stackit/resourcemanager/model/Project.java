...
public class Project {
  ...
  public Project containerId(@javax.annotation.Nonnull String containerId) {
  ...
  public Project creationTime(@javax.annotation.Nonnull OffsetDateTime creationTime) {
  ...
  public Project labels(@javax.annotation.Nullable Map<String, String> labels) {
    this.labels = labels;
    return this;
  }
  ...
  public Project lifecycleState(@javax.annotation.Nonnull LifecycleState lifecycleState) {
  ...
  public Project parent(@javax.annotation.Nonnull Parent parent) {
    this.parent = parent;
    return this;
  }
  ...
  public Project updateTime(@javax.annotation.Nonnull OffsetDateTime updateTime) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.containerId, project.containerId) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(containerId, creationTime, labels, lifecycleState, name, parent, projectId, updateTime);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("containerId", "creationTime", "labels", "lifecycleState", "name", "parent", "projectId", "updateTime"));
