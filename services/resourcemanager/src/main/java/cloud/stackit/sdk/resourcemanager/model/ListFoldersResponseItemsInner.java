...
public class ListFoldersResponseItemsInner {
  ...
  public ListFoldersResponseItemsInner creationTime(@javax.annotation.Nonnull OffsetDateTime creationTime) {
  ...
  public ListFoldersResponseItemsInner labels(@javax.annotation.Nullable Map<String, String> labels) {
    this.labels = labels;
    return this;
  }
  ...
  public ListFoldersResponseItemsInner updateTime(@javax.annotation.Nonnull OffsetDateTime updateTime) {
  ...
  public boolean equals(Object o) {
    ...
    ListFoldersResponseItemsInner listFoldersResponseItemsInner = (ListFoldersResponseItemsInner) o;
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListFoldersResponseItemsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListFoldersResponseItemsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListFoldersResponseItemsInner is not found in the empty JSON string", ListFoldersResponseItemsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListFoldersResponseItemsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListFoldersResponseItemsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListFoldersResponseItemsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListFoldersResponseItemsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListFoldersResponseItemsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListFoldersResponseItemsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ListFoldersResponseItemsInner>() {
           @Override
           public void write(JsonWriter out, ListFoldersResponseItemsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListFoldersResponseItemsInner read(JsonReader in) throws IOException {
   ...
   * @throws IOException if the JSON string is invalid with respect to ListFoldersResponseItemsInner
   */
