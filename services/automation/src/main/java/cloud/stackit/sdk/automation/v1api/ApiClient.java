...
public class ApiClient {
	...
	protected String basePath = "https://automation-service.api.stackit.cloud";
	protected List<ServerConfiguration> servers =
			new ArrayList<ServerConfiguration>(
					Arrays.asList(
							new ServerConfiguration(
									"https://automation-service.api.stackit.cloud",
	...
	protected void init() {
		...
		setUserAgent("stackit-sdk-java/automation");
	}
	 ...
	 * Set base path
	 *
	 * @param basePath Base path of the URL (e.g https://automation-service.api.stackit.cloud)
	 ...
	 * @return a {@link cloud.stackit.sdk.automation.v1api.ApiClient} object
	 */
