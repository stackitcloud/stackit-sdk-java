...
public class Template {
	...
	public Template createTime(@javax.annotation.Nonnull OffsetDateTime createTime) {
	...
	public Template name(@javax.annotation.Nonnull String name) {
		this.name = name;
		return this;
	}
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(this.createTime, template.createTime)
	...
	@Override
	public int hashCode() {
		return Objects.hash(createTime, description, id, name, additionalProperties);
	}
	...
	public static void validateJsonElement(JsonElement jsonElement) throws IOException {
		if (jsonElement == null) {
			if (!Template.openapiRequiredFields
					.isEmpty()) { // has required fields but JSON element is null
				throw new IllegalArgumentException(
						String.format(
								java.util.Locale.ROOT,
								"The required field(s) %s in Template is not found in the empty JSON string",
								Template.openapiRequiredFields.toString()));
			}
		}
