...
public class ApiClient {
	...
	protected String basePath = "https://alb.api.stackit.cloud";
	protected List<ServerConfiguration> servers =
			new ArrayList<ServerConfiguration>(
					Arrays.asList(
							new ServerConfiguration(
									"https://alb.api.stackit.cloud",
	...
	protected void init() {
		...
		setUserAgent("stackit-sdk-java/alb");
	}
	 ...
	 * @return a {@link cloud.stackit.sdk.alb.v2beta2api.ApiClient} object
	 */
