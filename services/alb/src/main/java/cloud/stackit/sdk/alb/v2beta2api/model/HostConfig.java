...
public class HostConfig {
	 ...
	 * @return the HostConfig instance itself
	 */
	public HostConfig putAdditionalProperty(String key, Object value) {
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(this.host, hostConfig.host)
				...
				&& Objects.equals(this.additionalProperties, hostConfig.additionalProperties);
	}

	@Override
	public int hashCode() {
		return Objects.hash(host, rules, additionalProperties);
	}
			...
			return (TypeAdapter<T>)
					new TypeAdapter<HostConfig>() {
						...
						public HostConfig read(JsonReader in) throws IOException {
							...
							HostConfig instance = thisAdapter.fromJsonTree(jsonObj);
