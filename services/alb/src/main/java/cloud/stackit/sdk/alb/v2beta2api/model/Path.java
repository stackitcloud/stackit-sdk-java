...
public class Path {
	...
	@javax.annotation.Nullable private String exact;
	...
	public Path exact(@javax.annotation.Nullable String exact) {
		this.exact = exact;
		return this;
	}
	 ...
	 * @return exact
	 */
	@javax.annotation.Nullable public String getExact() {
		return exact;
	}

	public void setExact(@javax.annotation.Nullable String exact) {
		this.exact = exact;
	}
	...
	public boolean equals(Object o) {
		...
		Path path = (Path) o;
		return Objects.equals(this.exact, path.exact)
	...
	@Override
	public int hashCode() {
		return Objects.hash(exact, prefix, additionalProperties);
	}
	...
	static {
		...
		openapiFields = new HashSet<String>(Arrays.asList("exact", "prefix"));
	...
	public static void validateJsonElement(JsonElement jsonElement) throws IOException {
		...
		if ((jsonObj.get("exact") != null && !jsonObj.get("exact").isJsonNull())
				&& !jsonObj.get("exact").isJsonPrimitive()) {
			throw new IllegalArgumentException(
					String.format(
							java.util.Locale.ROOT,
							"Expected the field `exact` to be a primitive type in the JSON string but got `%s`",
							jsonObj.get("exact").toString()));
		}
