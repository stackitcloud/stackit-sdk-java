...
public class Rule {
	...
	@javax.annotation.Nullable private String pathPrefix;
	...
	public Rule pathPrefix(@javax.annotation.Nullable String pathPrefix) {
		this.pathPrefix = pathPrefix;
		return this;
	}

	/**
	 * Legacy path prefix match. Optional. If not set, defaults to root path &#39;/&#39;. Cannot be
	 * set if &#39;path&#39; is used. Prefer using &#39;path.prefix&#39; instead. Only matches on
	 * full segment boundaries, e.g. &#39;/foo&#39; matches &#39;/foo&#39; and &#39;/foo/bar&#39;
	 * but NOT &#39;/foobar&#39;.
	 *
	 * @return pathPrefix
	 */
	@javax.annotation.Nullable public String getPathPrefix() {
		return pathPrefix;
	}
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(this.cookiePersistence, rule.cookiePersistence)
				...
				&& Objects.equals(this.pathPrefix, rule.pathPrefix)
	...
	public static void validateJsonElement(JsonElement jsonElement) throws IOException {
		...
		if ((jsonObj.get("pathPrefix") != null && !jsonObj.get("pathPrefix").isJsonNull())
			...
			throw new IllegalArgumentException(
					String.format(
							java.util.Locale.ROOT,
							"Expected the field `pathPrefix` to be a primitive type in the JSON string but got `%s`",
