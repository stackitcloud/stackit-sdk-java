 ...
 * &#x60;allowed_source_ranges&#x60; and &#x60;ip_block_list_name&#x60; may be set together. When
 * both are set, &#x60;allowed_source_ranges&#x60; is evaluated first, then
 * &#x60;ip_block_list_name&#x60; is evaluated.
 */
...
public class LoadbalancerOptionAccessControl {
	...
	/**
	 * Application Load Balancer is accessible only from an IP address in this range. May be
	 * combined with &#x60;ipBlockListName&#x60;; &#x60;allowedSourceRanges&#x60; is evaluated
	 * first, then &#x60;ipBlockListName&#x60;.
	 *
	 ...
	 * manage IP block lists. May be combined with &#x60;allowedSourceRanges&#x60;;
	 * &#x60;allowedSourceRanges&#x60; is evaluated first, then &#x60;ipBlockListName&#x60;.
	 *
