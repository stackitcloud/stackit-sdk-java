...
package cloud.stackit.sdk.alb.v2beta2api.model;

import cloud.stackit.sdk.alb.v2beta2api.JSON;
...
public class UpdateLoadBalancerPayload {
	...
	public UpdateLoadBalancerPayload() {}
	...
	public UpdateLoadBalancerPayload disableTargetSecurityGroupAssignment(
	...
	public UpdateLoadBalancerPayload externalAddress(
	...
	/**
	 * External application load balancer IP address where this application load balancer is
	 * exposed. Not changeable after creation.
	 *
	...
	public UpdateLoadBalancerPayload labels(@javax.annotation.Nullable Map<String, String> labels) {
		this.labels = labels;
		return this;
	}

	public UpdateLoadBalancerPayload putLabelsItem(String key, String labelsItem) {
		if (this.labels == null) {
	 ...
	 * per ALB. **Key Formatting Rules:** Length: 1-63 characters. Characters: Must begin and end
	...
	public UpdateLoadBalancerPayload listeners(
			@javax.annotation.Nullable List<Listener> listeners) {
		this.listeners = listeners;
		return this;
	}

	public UpdateLoadBalancerPayload addListenersItem(Listener listenersItem) {
	...
	public UpdateLoadBalancerPayload name(@javax.annotation.Nullable String name) {
		this.name = name;
		return this;
	}
	...
	public UpdateLoadBalancerPayload networks(@javax.annotation.Nullable List<Network> networks) {
		this.networks = networks;
		return this;
	}

	public UpdateLoadBalancerPayload addNetworksItem(Network networksItem) {
	...
	public UpdateLoadBalancerPayload options(
	...
	public UpdateLoadBalancerPayload planId(@javax.annotation.Nullable String planId) {
		this.planId = planId;
		return this;
	}

	/**
	 * Service Plan configures the size of the Application Load Balancer. Currently supported plans
	 * are p10, p50, p250 and p750. This list can change in the future where plan ids will be
	 * removed and new plans by added. That is the reason this is not an enum.
	 *
	 * @return planId
	 */
	...
	public UpdateLoadBalancerPayload targetPools(
			@javax.annotation.Nullable List<TargetPool> targetPools) {
		this.targetPools = targetPools;
		return this;
	}

	public UpdateLoadBalancerPayload addTargetPoolsItem(TargetPool targetPoolsItem) {
	...
	public UpdateLoadBalancerPayload version(@javax.annotation.Nullable String version) {
		this.version = version;
		return this;
	}

	/**
	 * Application Load Balancer resource version. Must be empty or unset for creating load
	 * balancers, non-empty for updating load balancers. Semantics: While retrieving load balancers,
	 * this is the current version of this application load balancer resource that changes during
	 * updates of the load balancers. On updates this field specified the application load balancer
	 * version you calculated your update for instead of the future version to enable concurrency
	 * safe updates. Update calls will then report the new version in their result as you would see
	 * with a application load balancer retrieval call later. There exist no total order of the
	 * version, so you can only compare it for equality, but not for less/greater than another
	 * version. Since the creation of application load balancer is always intended to create the
	 * first version of it, there should be no existing version. That&#39;s why this field must by
	 * empty of not present in that case.
	 *
	 * @return version
	 */
	 ...
	 * @return the UpdateLoadBalancerPayload instance itself
	 */
	public UpdateLoadBalancerPayload putAdditionalProperty(String key, Object value) {
	...
	public boolean equals(Object o) {
		...
		UpdateLoadBalancerPayload updateLoadBalancerPayload = (UpdateLoadBalancerPayload) o;
		return Objects.equals(
						this.disableTargetSecurityGroupAssignment,
						updateLoadBalancerPayload.disableTargetSecurityGroupAssignment)
				&& Objects.equals(this.errors, updateLoadBalancerPayload.errors)
				&& Objects.equals(this.externalAddress, updateLoadBalancerPayload.externalAddress)
				&& Objects.equals(this.labels, updateLoadBalancerPayload.labels)
				&& Objects.equals(this.listeners, updateLoadBalancerPayload.listeners)
				&& Objects.equals(
						this.loadBalancerSecurityGroup,
						updateLoadBalancerPayload.loadBalancerSecurityGroup)
				&& Objects.equals(this.name, updateLoadBalancerPayload.name)
				&& Objects.equals(this.networks, updateLoadBalancerPayload.networks)
				&& Objects.equals(this.options, updateLoadBalancerPayload.options)
				&& Objects.equals(this.planId, updateLoadBalancerPayload.planId)
				&& Objects.equals(this.privateAddress, updateLoadBalancerPayload.privateAddress)
				&& Objects.equals(this.region, updateLoadBalancerPayload.region)
				&& Objects.equals(this.status, updateLoadBalancerPayload.status)
				&& Objects.equals(this.targetPools, updateLoadBalancerPayload.targetPools)
				&& Objects.equals(
						this.targetSecurityGroup, updateLoadBalancerPayload.targetSecurityGroup)
				&& Objects.equals(this.version, updateLoadBalancerPayload.version)
				&& Objects.equals(
						this.additionalProperties, updateLoadBalancerPayload.additionalProperties);
	}
	...
	public String toString() {
		...
		sb.append("class UpdateLoadBalancerPayload {\n");
	 ...
	 * @throws IOException if the JSON Element is invalid with respect to UpdateLoadBalancerPayload
	 */
	public static void validateJsonElement(JsonElement jsonElement) throws IOException {
		if (jsonElement == null) {
			if (!UpdateLoadBalancerPayload.openapiRequiredFields
	...
	public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
		...
		public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
			if (!UpdateLoadBalancerPayload.class.isAssignableFrom(type.getRawType())) {
				return null; // this class only serializes 'UpdateLoadBalancerPayload' and its
				// subtypes
			}
			final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
			final TypeAdapter<UpdateLoadBalancerPayload> thisAdapter =
					gson.getDelegateAdapter(this, TypeToken.get(UpdateLoadBalancerPayload.class));

			return (TypeAdapter<T>)
					new TypeAdapter<UpdateLoadBalancerPayload>() {
						@Override
						public void write(JsonWriter out, UpdateLoadBalancerPayload value)
								throws IOException {
						...
						@Override
						public UpdateLoadBalancerPayload read(JsonReader in) throws IOException {
							JsonElement jsonElement = elementAdapter.read(in);
							validateJsonElement(jsonElement);
							JsonObject jsonObj = jsonElement.getAsJsonObject();
							// store additional fields in the deserialized instance
							UpdateLoadBalancerPayload instance = thisAdapter.fromJsonTree(jsonObj);
	...
	/**
	 * Create an instance of UpdateLoadBalancerPayload given an JSON string
	 *
	 * @param jsonString JSON string
	 * @return An instance of UpdateLoadBalancerPayload
	 * @throws IOException if the JSON string is invalid with respect to UpdateLoadBalancerPayload
	 */
	public static UpdateLoadBalancerPayload fromJson(String jsonString) throws IOException {
		return JSON.getGson().fromJson(jsonString, UpdateLoadBalancerPayload.class);
	}

	/**
	 * Convert an instance of UpdateLoadBalancerPayload to an JSON string
	 *
	 * @return JSON string
	 */
