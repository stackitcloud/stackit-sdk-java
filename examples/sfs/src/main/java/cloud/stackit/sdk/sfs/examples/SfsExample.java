...
public final class SfsExample {
	...
	public static void main(String[] args) throws IOException {
		...
		try {
			/*
			 * ///////////////////////////////////////////////////////
			 * //        S N A P S H O T   S C H E D U L E S        //
			 * ///////////////////////////////////////////////////////
			 */
			System.out.println("\nList snapshot schedules:");
			ListSnapshotSchedulesResponse listSnapshotSchedulesResponse =
					sfsApi.listSnapshotSchedules(projectId);
			Objects.requireNonNull(listSnapshotSchedulesResponse.getSnapshotSchedules());
			for (SnapshotSchedule snapshotSchedule :
					listSnapshotSchedulesResponse.getSnapshotSchedules()) {
				System.out.println("*************************");
				System.out.println("* Schedule Name: " + snapshotSchedule.getName());
				System.out.println("* Cron: " + snapshotSchedule.getCron());
			}
			...
			CreateResourcePoolResponse createResourcePoolResponse =
					sfsApi.createResourcePool(
							...
							new CreateResourcePoolPayload()
									.name("java-sdk-example-resource-pool")
									.sizeGigabytes(512)
