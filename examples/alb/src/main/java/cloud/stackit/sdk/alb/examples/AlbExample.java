	...
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			while (Objects.equals(
				...
				System.out.println("Waiting for application load balancer creation to complete ...");
			...
			while (true) {
				try {
					applicationLoadBalancerApi.getLoadBalancer(
							projectId, region, fetchedLoadbalancer.getName());
					System.out.println("Waiting for application load balancer deletion to complete ...");
					TimeUnit.SECONDS.sleep(5);
